...
* Winbond `25Q32JVSIQ`, 32 Mbits SPI flash ([datasheet](datasheets/w25q32jv_spi_revc_08302016.pdf), [image](images/cl-5a-75b-v82-25Q32JVSIQ.jpg))
* 2x Realtek `RTL8211FP` Gigabit Ethernet PHYs ([datasheet](datasheets/RTL8211F-CG-RealtekMicroelectronics.pdf), [image](images/cl-5a-75b-v82-RTL8211FP.jpg))  
  *Note: I can't seem to find anything about the `FP` specifically so it could be an `F` or `FD`*
* 1x ESMT `M12L64322A` 2M 200MHz SDRAM (organized as 4 x 512k x 32bit) ([datasheet](datasheets/M12L64322A(2S).pdf), [image](images/cl-5a-75b-v82-M12L64322A.jpg))
* 12x `DP245D` Octal Bidirectional Transceiver (used for level translation to 5V) ([image](images/cl-5a-75b-v82-DP245D.jpg))  
